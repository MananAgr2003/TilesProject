      ...
      >
        ...
        >
          ...
          >
            ...
            <img src={hover1} alt="" onMouseOver={() => changeImgURL(banner1)} onMouseOut={() => changeImgURL(banner)}/>
          </Box>
          ...
          >
            <img src={hover2} alt="" onMouseOver={() => changeImgURL(banner2)} onMouseOut={() => changeImgURL(banner)}/>
          </Box>
          ...
          >
            <img src={hover3} alt="" onMouseOver={() => changeImgURL(banner3)} onMouseOut={() => changeImgURL(banner)}/>
          </Box>
          ...
          >
            <img src={hover4} alt="" onMouseOver={() => changeImgURL(banner4)} onMouseOut={() => changeImgURL(banner)}/>
          </Box>
          ...
          >
            <img src={hover5} alt="" onMouseOver={() => changeImgURL(banner5)} onMouseOut={() => changeImgURL(banner)}/>
          </Box>
          ...
          >
            <img src={hover6} alt="" onMouseOver={() => changeImgURL(banner6)} onMouseOut={() => changeImgURL(banner)}/>
          </Box>
          ...
          >
            <img src={hover7} alt="" onMouseOver={() => changeImgURL(banner7)} onMouseOut={() => changeImgURL(banner)}/>
          </Box>
          ...
          >
            <img src={hover8} alt="" onMouseOver={() => changeImgURL(banner2)} onMouseOut={() => changeImgURL(banner)}/>
          </Box>
          </Box>
